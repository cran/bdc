...
Save the original database containing the results of all data quality tests appended in separate columns. You can use [qs::qread()]{.ul} instead of write_csv to save a large database in a compressed format.
...
You can use [qs::qread()]{.ul} instead of write_csv to save a large database in a compressed format.
